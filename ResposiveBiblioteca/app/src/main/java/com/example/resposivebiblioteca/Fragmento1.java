    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setListAdapter(new Adaptador(getActivity(), R.layout.layout_listado, Contenido.ENT_LISTA) {
            ...
            public void onEntrada(Object entrada, View view) {
                ...
                texto_superior_entrada.setText(((Contenido.Lista_entrada) entrada).get_textoTitulo());
                ImageView imagen_emtrada = (ImageView) view.findViewById(R.id.imagenlista);
                imagen_emtrada.setImageResource(((Contenido.Lista_entrada) entrada).get_idImagen());
            }
        });
    }
