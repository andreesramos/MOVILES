...
public class Fragmento3 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if(miItem != null){
            ((TextView) rootView.findViewById(R.id.textoTitulo)).setText(miItem.get_textoTitulo());
            ((TextView) rootView.findViewById(R.id.textocontenido)).setText(miItem.get_textoContenido());
            ((ImageView) rootView.findViewById(R.id.imagen)).setImageResource(miItem.get_idImagen());
        }
        return rootView;
    }
}
